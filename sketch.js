...
function preload(){
    ...
    dogg = loadImage("images/lazy.png")
    ...
    viewFood_img=loadImage("images/Food Stock.png")
    viewSchedule_img=loadImage("images/dogVaccination.png")
    Inject_img=loadImage("images/injection.png")
